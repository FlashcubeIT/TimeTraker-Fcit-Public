...
import ServerFileImg from "../../img/ServerFile.png";
                ...
                <div className={sideBarStatus ? 'content_right_dashboard_3' : "none"} fluid style={sideBarStatus == true & forPhoneScreenNoDisplay == false ? { display: 'none' } : { display: 'block' }}>
                    ...
                    <div>
                        ...
                        <div className='technical_doc backend_file_structure' style={{ padding: "0px 20px 30px 20px" }}>
                            ...
                            <p>Click <a href='https://drive.google.com/file/d/10XMJXazW__7NdeL1H461WUBtCyqO-rCI/view?usp=sharing'>Here</a> to download the PDF of this file structure.</p>
                            <div>
                                <img src={ServerFileImg} alt='Node Server File Structure' />
                            </div>
                        </div>
