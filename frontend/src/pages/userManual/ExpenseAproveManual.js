            ...
            <AdminSideBarManual>
                <div className={sideBarStatus ? 'content_right_dashboard_3' : "none"} fluid style={sideBarStatus == true & forPhoneScreenNoDisplay == false ? { display: 'none' } : { display: 'block' }}>
                    ...
                    <div className='user_manual' style={{ padding: "0px 20px" }}>
                        <h2>
                            Steps to Approve The Expense.

                        </h2>
                        <div className='step_save_div'>
                            <p><span className='process'>Process 1 :-</span> </p>
                            <p className='inside_process'><span>Step 1 :-</span> Go to the <strong>Expense</strong> page. </p>
                            <p className='inside_process'><span>Step 2 :-</span> Click on the  <strong>User</strong>, which will open all the <strong>Submitted Expenses</strong>  by this user.</p>
                            <p className='inside_process'><span>Step 3 :-</span> Click on the <strong> Thumb Up Icon </strong> to approve the expense. </p>
                            {/* <div className='note'>
                        ...
                        <div className='step_save_div'>
                            ...
                            <p className='inside_process'><span>Step 1 :-</span> Go to the <strong>Expense</strong> page. </p>
                            <p className='inside_process'><span>Step 2 :-</span> Select <strong> By Status </strong> in the top right corner. It will show you all the <strong> Submitted Expenses</strong>.</p>
                            <p className='inside_process'><span>Step 3 :-</span> Click on the <strong> Thumb Up Icon </strong> to approve the expense. </p>
                            <div className='note'>
                                <p ><span>Note 1 :- </span>  If you are not able to see any expense on the approved expense page it means no one has submitted any new expenses.  </p>
                            </div>
                        </div>
...
export default ExpenseAproveManual
